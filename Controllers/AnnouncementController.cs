...
namespace TADS_Web.Controllers
{
    public class AnnouncementController : BaseController
    {
        ...
        public AnnouncementController(AllCommonService allCommonService,
        ...
        public async Task<IActionResult> List(VM_News data)
        {
            UserSessionModel userinfo = GetUserInfo();
            string Feature = "公告訊息管理", Action = "檢視";
        ...
        public async Task<IActionResult> Create()
        {
            ...
            await _commonService.OperateLog(userinfo.UserID, "新增公告訊息", "新增");
            return View(data);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create(VM_News datapost)
        {
            UserSessionModel userinfo = GetUserInfo();
            string Feature = "公告訊息新增", Action = "新增";
        ...
        {
            UserSessionModel userinfo = GetUserInfo();
            string Feature = "公告訊息編輯", Action = "檢視";
            VM_News data = new VM_News();
            bool isSuccess = false;
            bool unCaughtError = false;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Modify(string id, VM_News datapost)
        {
            UserSessionModel userinfo = GetUserInfo();
            string Feature = "公告訊息編輯", Action = "編輯";
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            UserSessionModel userinfo = GetUserInfo();
            string Feature = "公告訊息管理", Action = "刪除";
            DateTime dtnow = DateTime.Now;
            bool isSuccess = false;
            bool unCaughtError = false;
        ...
        public async Task<IActionResult> PublishChange(string id)
        {
            JsonResponse<TbNews> result = new JsonResponse<TbNews>();
            UserSessionModel userinfo = GetUserInfo();
            string Feature = "公告訊息管理", Action = "編輯";
            DateTime dtnow = DateTime.Now;
            bool isSuccess = false;
            bool unCaughtError = false;
